<%-- 
    Document   : SaisirCouturier
    Created on : Nov 28, 2015, 3:18:36 PM
    Author     : Meriem
--%>
...
<html>
    <head>
        ...
        <title>Saisir un nouveau couturier</title>
    </head>
    <body>
        <h1>Créer un nouveau compte couturier</h1>
        <form method="get" action="Menu">
            <fieldset>
                <legend>Informations Couturier</legend>
                ...
                <br/>
                    ...
                    <input type="hidden" name="action" value="creerCouturier">
            </fieldset>
            <hr>
                <br/>
