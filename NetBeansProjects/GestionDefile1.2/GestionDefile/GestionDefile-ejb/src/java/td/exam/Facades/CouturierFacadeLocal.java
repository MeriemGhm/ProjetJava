...
public interface CouturierFacadeLocal {
    ...
    java.util.List<Couturier> rechercheCourturierNom(String nom);

    java.util.Collection<Couturier> rechercherCouturiers();

    Couturier rechercheCouturierId(long coutId);
